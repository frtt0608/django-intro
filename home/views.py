...
def dinner(request):
    ...
    return render(request, '/home/dinner.html', {'dinners': dinners, 'box': box})
...
def user_read(request):
    ...
    return render(request, 'home/user_read.html', {'id':id, 'password':password})
...
def template_example(request):
    ...
    return render(request, 'home/template_example.html', {'my_dict':my_dict, 'my_list':my_list, 'my_sentence':my_sentence, 'messages': messages, 'datetimenow': datetimenow })
